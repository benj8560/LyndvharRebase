...
/mob/living/simple_animal/hostile/retaliate/rogue/fogbeast/kid
	name = "fogbeast filly"
	desc = "A young fogbeast, likely to be running around with its mother. Fogbeasts are a distant cousin to the saiga - and far, far rarer. \
	A filly like this one is a treasured thing indeed- men have been broken on the wheel for harming a creature like this."
	icon = 'icons/roguetown/mob/monster/fogbeast.dmi'
	icon_state = "foggie"
	icon_living = "foggie"
