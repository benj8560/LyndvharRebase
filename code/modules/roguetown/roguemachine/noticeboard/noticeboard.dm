...
/obj/structure/roguemachine/noticeboard/attack_hand(mob/living/carbon/human/user)
	...
	if(user.job in list("Watchman","Inquisitor", "Cataphract", "Watch Captain", "Retinue Captain", "Orthodoxist", "Absolver"))
		can_remove = TRUE
	...
	if(current_category in list("Postings", "Premium Postings"))
		...
		contents += "Only the outskirts of the City, the Draguippe, the coastal regions, and the Terrorbog can be rendered safe entirely. <br>" 
