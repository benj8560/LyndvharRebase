/obj/item/net
	...
	icon_state = "net"
	slipouttime = 3 SECONDS //ideally you're using this to catch a dodger, not in the middle of combat
	breakouttime = 0.5 SECONDS //very easy to break out of if you have high strength
	gender = NEUTER
	throw_speed = 2
	var/knockdown = 0
