...
/obj/item/gun/ballistic/revolver/grenadelauncher/bow/recurve/warden
	...
	desc = "When a northern black-horned saiga is old enough, it will shed its two-metre long antlers. As time passes, they harden progressively more but keep a degree of flexibility that can outdo even yew.\
		...
		and thus one can see Draguippe wardens carrying their endemic blackhorn bows with pride."
...
/obj/item/gun/ballistic/revolver/grenadelauncher/bow/recurve/steppesman
	...
	desc = "A short recurve warbow made for the express purpose of shooting on saigaback, a skill every archer in Vruirid takes much more seriously than their Northern counterparts. Every seasoned Druzhina is themselves a good bowyer and usually makes their own bow, this one is made with the purpure-ish crimson wood of a Vörötslevé tree."
