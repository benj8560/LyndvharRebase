...
/obj/item/rogueweapon/scabbard/sword/saltlian/kodachi
	...
	valid_blade = /obj/item/rogueweapon/sword/short/saltlian
	wdefense = 4

/obj/item/rogueweapon/scabbard/sheath/saltlian
	...
	valid_blade = /obj/item/rogueweapon/huntingknife/idagger/steel/saltlian
	associated_skill = /datum/skill/combat/shields
	possible_item_intents = list(SHIELD_BASH, SHIELD_BLOCK)
	can_parry = TRUE
	wdefense = 3
